...
public:
  ...
  inline Halfedge get_opposite_edge( Edge_ID, Access_Mode mode=ACROSS_PANE) const;
...
//  typedef std::vector< Pane_manifold_2>::const_iterator PM_const_iterator;
   ...
   */
  void compute_normals( COM::DataItem *normals, 
   ...
   */
  void elements_to_nodes( const COM::DataItem *evals,
			  COM::DataItem *nvals,
			  const int scheme = E2N_ONE,
			  const COM::DataItem *ews = NULL,
			  COM::DataItem *nws = NULL,
...
protected:
   ...
   */
  void compute_nodal_normals( COM::DataItem *nrm,
			      int scheme = E2N_ANGLE,
			      bool to_normalize = true,
...
public:
  ...
  Halfedge halfedge() const {
    return Halfedge(_pm, Edge_ID(_fID,0),_mode);
  }
...
{ return Face(_pm, _eID.eid(),_mode); }
