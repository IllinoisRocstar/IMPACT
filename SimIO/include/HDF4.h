...
class HDF4 {
 public:
  ...
  static int32 SDcreate(int32 sd_id, const char *name, int32 dType, int32 rank,
                        int32 *size);
  ...
  static intn SDsetdatastrs(int32 sds_id, const char *label, const char *units,
  ...
  static intn SDwritedata(int32 sds_id, int32 *start, int32 *stride, int32 *end,
                          VOIDP data);
  static intn SDreaddata(int32 sds_id, int32 *start, int32 *stride, int32 *end,
                         VOIDP data);
