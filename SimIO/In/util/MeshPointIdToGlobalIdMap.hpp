...
class MeshPointIdToGlobalIdMap {
 ...
 public:
  ...
  /**
   * @brief This method constructs a new key-pair for the meshPaneId and
   * meshPointId which maps into globalId and inserts it into the
   * data-structure.
   * @param meshPaneId the pane id of the mesh in query.
   * @param meshPointId the point id of the mesh point in query.
   ...
   */
  inline void insert(const int meshPaneId, const int meshPointId,
                     const int globalId) {
    //				std::cout << "Mesh Pane Id: " << meshPaneId << "
    //"; 				std::cout << "Mesh Point Id: " << meshPointId << " "; 				std::cout <<
