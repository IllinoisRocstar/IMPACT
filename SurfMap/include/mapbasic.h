...
class Vector_3 {
 public:
  ...
  static Vector_3 cross_product(const Vector_3 &v, const Vector_3 &w) {
    return Vector_3(v._y * w._z - v._z * w._y, v._z * w._x - v._x * w._z,
                    v._x * w._y - v._y * w._x);
  }
...
class Point_3 : protected Vector_3<T> {
 public:
  ...
  bool operator<(const Point_3 &v) const { return Vector_3<T>::operator<(v); }
...
class Vector_2 {
 public:
  ...
  Vector_2 operator*(const Type t) const { return Vector_2(_x * t, _y * t); }
  Vector_2 operator/(const Type t) const { return Vector_2(_x / t, _y / t); }
  Type operator*(const Vector_2 &v) const { return _x * v._x + _y * v._y; }

  Vector_2 operator-() const { return Vector_2(-_x, -_y); }
...
class Point_2 : protected Vector_2<T> {
 public:
  ...
  bool operator<(const Point_2 &v) const { return Vector_2<T>::operator<(v); }
