...
struct Two_tuple {
  ...
  Two_tuple() {}
  Two_tuple(Init_reference p, Init_reference q) : v0(p), v1(q) {}
  explicit Two_tuple(Const_reference t) : v0(t), v1(t) {}

  Const_reference operator[](int i) const {
    return Traits::ref(
        reinterpret_cast<Pointer_equivalent>(const_cast<Self*>(this)) + i);
  }
  ...
  operator Const_self&() const { return reinterpret_cast<Const_self&>(*this); }

  Self operator+(const Self& t) const { return Self(v0 + t.v0, v1 + t.v1); }
  ...
  Value operator*(const Self& t) const { return v0 * t.v0 + v1 * t.v1; }
  ...
  Self operator/(Const_reference t) const { return Self(v0 / t, v1 / t); }
  ...
  Self multiply(const Self& b) const { return Self(v0 * b.v0, v1 * b.v1); }
...
struct Four_tuple {
  ...
  Four_tuple() {}
  Four_tuple(Init_reference p, Init_reference q, Init_reference r,
             Init_reference s)
      : v0(p), v1(q), v2(r), v3(s) {}
