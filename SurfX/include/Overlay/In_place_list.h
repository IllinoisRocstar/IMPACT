...
class In_place_list {
 ...
 public:
  ...
  iterator insert(T* pos, T& x) { return insert(iterator(pos, dim), x); }
  ...
  void insert(iterator pos, InputIterator first, InputIterator last) {
    while (first != last) insert(pos, *get_node(*first++));
  }
...
template <class T, bool managed>
void In_place_list<T, managed>::erase(_In_place_list_iterator<T> first,
