...
public:
  ...
  void overlay( const COM::DataItem *mesh1, 
		const COM::DataItem *mesh2,
  ...
  void write_overlay( const COM::DataItem *mesh1, 
		      const COM::DataItem *mesh2, 
  ...
  void read_overlay( const COM::DataItem *mesh1,
		     const COM::DataItem *mesh2,
		     const MPI_Comm *comm, 
		     const char *prefix1=NULL,
		     const char *prefix2=NULL,
  ...
  void set_tags( const COM::DataItem *src, 
		 const COM::DataItem *trg,
  ...
  void least_squares_transfer( const COM::DataItem *att1, 
			       COM::DataItem *att2,
			       const Real *alp=NULL,
			       const int *ord=NULL,
			       Real *tol=NULL, 
  ...
  void interpolate( const COM::DataItem *att1, 
		    COM::DataItem *att2);

  void load_transfer( const COM::DataItem *att1, 
		      COM::DataItem *att2, 
...
protected:
  ...
  void transfer( const COM::DataItem *src, COM::DataItem *trg,
