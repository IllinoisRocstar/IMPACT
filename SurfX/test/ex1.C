...
int main(int argc, char *argv[]) {
  ...
  COM_new_dataitem("unstr.velo", 'n', COM_DOUBLE, 3, "m/s");
  COM_new_dataitem("unstr.disp", 'n', COM_DOUBLE, 3, "m");
  COM_new_dataitem("unstr.burnr", 'e', COM_DOUBLE, 3, "m/s");
  ...
  COM_new_window("str");
  COM_new_dataitem("str.velo", 'n', COM_DOUBLE, 3, "m/s");
  COM_new_dataitem("str.disp", 'n', COM_DOUBLE, 3, "m");
  COM_new_dataitem("str.burnr", 'e', COM_DOUBLE, 3, "m/s");
