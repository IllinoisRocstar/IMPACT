...
#ifndef __COM_FUNCTION_H__
#define __COM_FUNCTION_H__
...
class Function {
 public:
   ...
   */
  /// Default constructor.
  Function() : _ptr(NULL), _attr(NULL), _comm(MPI_COMM_NULL), _ftype(C_FUNC) {}
   ...
   *           an dataitem. If it is COM_RAWDATA, then argument should be
   *           the physical address of the values of an dataitem. Otherwise,
   *           it is literal type and the argument should be a pointer to
   *           corresponding data type.
   *  \param a dataitem with which a member functions is associated.
   *  \param b whether the function is a Fortran subroutine
   */
  Function(Func_ptr p, const std::string &s, const int *t, DataItem *a,
           bool b = false)
      : _ptr(p),
        _intents(s),
        _types(t, t + s.size()),
        _attr(a),
        _comm(MPI_COMM_NULL),
        _ftype(b ? F_FUNC : C_FUNC) {}
  Function(Member_func_ptr p, const std::string &s, const int *t, DataItem *a)
      : _mem_ptr(p),
        _intents(s),
        _types(t, t + s.size()),
        _attr(a),
  ...
  bool is_metadata(int i) const { return _types[i] == COM_METADATA; }
  ...
  DataItem *dataitem() { return _attr; }
  //\}
  ...
  void operator()(void *a1, void *a2, void *a3, void *a4, void *a5, void *a6) {
    if (_ftype != CPP_MEMBER) {
      ...
      typedef void (COM_Object::*Member_Func6)(void *, void *, void *, void *,
                                               void *);
  ...
  void operator()(void *a1, void *a2, void *a3, void *a4, void *a5, void *a6,
                  void *a7) {
    if (_ftype != CPP_MEMBER) {
      typedef void (*Func7)(void *, void *, void *, void *, void *, void *,
                            void *);
  ...
  void operator()(void *a1, void *a2, void *a3, void *a4, void *a5, void *a6,
                  void *a7, void *a8) {
    if (_ftype != CPP_MEMBER) {
      typedef void (*Func8)(void *, void *, void *, void *, void *, void *,
                            void *, void *);
  ...
  void operator()(void *a1, void *a2, void *a3, void *a4, void *a5, void *a6,
    ...
    if (_ftype != CPP_MEMBER) {
      ...
      typedef void (COM_Object::*Member_Func9)(void *, void *, void *, void *,
                                               void *, void *, void *, void *);
  ...
  void operator()(void *a1, void *a2, void *a3, void *a4, void *a5, void *a6,
    ...
    if (_ftype != CPP_MEMBER) {
      ...
      typedef void (COM_Object::*Member_Func10)(void *, void *, void *, void *,
                                                void *, void *, void *, void *,
                                                void *);
  ...
  void operator()(void *a1, void *a2, void *a3, void *a4, void *a5, void *a6,
    ...
    if (_ftype != CPP_MEMBER) {
      ...
      typedef void (COM_Object::*Member_Func11)(void *, void *, void *, void *,
                                                void *, void *, void *, void *,
                                                void *, void *);
  ...
  void operator()(void *a1, void *a2, void *a3, void *a4, void *a5, void *a6,
    ...
    if (_ftype != CPP_MEMBER) {
      ...
      typedef void (COM_Object::*Member_Func11)(
 ...
 private:
  void validate_object(void *a1) {
    ...
    switch (ierr) {
      case 1:
        COM_assertion_msg(ierr == 0, "Invalid pointer after casting");
      case 3:
        COM_assertion_msg(ierr == 0,
                          "Invalid pointer and cookie after casting");
      default:;
    }
  }
  ...
  DataItem *_attr;               ///< Member function
  MPI_Comm _comm;
