...
! COM types
      ...
      INTERFACE
         ...
         SUBROUTINE COM_NEW_DATAITEM( WA_NAME, LOC, TYPE, SIZE, UNIT)
           CHARACTER(*), INTENT(IN) :: WA_NAME, LOC, UNIT
           INTEGER, INTENT(IN)      :: TYPE, SIZE
         END SUBROUTINE COM_NEW_DATAITEM

         SUBROUTINE COM_DELETE_DATAITEM( WA_NAME)
           CHARACTER(*), INTENT(IN) :: WA_NAME
         END SUBROUTINE COM_DELETE_DATAITEM
      ...
      INTERFACE COM_USE_DATAITEM
         SUBROUTINE COM_USE_DATAITEM( WNAME, WANAME)
           CHARACTER(*), INTENT(IN) :: WNAME, WANAME
         END SUBROUTINE COM_USE_DATAITEM
         
         SUBROUTINE COM_USE_DATAITEM_GHOST( WNAME, WANAME, WITHGHOST)
           CHARACTER(*), INTENT(IN) :: WNAME, WANAME
           INTEGER, INTENT(IN) :: WITHGHOST
         END SUBROUTINE COM_USE_DATAITEM_GHOST

         SUBROUTINE COM_USE_DATAITEM_SUB( WNAME, WANAME, WITHGHOST, PTNNAME, VAL)
           CHARACTER(*), INTENT(IN) :: WNAME, WANAME, PTNNAME
           INTEGER, INTENT(IN) :: VAL, WITHGHOST
         END SUBROUTINE COM_USE_DATAITEM_SUB
      END INTERFACE

      INTERFACE COM_CLONE_DATAITEM
         SUBROUTINE COM_CLONE_DATAITEM( WNAME, WANAME)
           CHARACTER(*), INTENT(IN) :: WNAME, WANAME
         END SUBROUTINE COM_CLONE_DATAITEM
         
         SUBROUTINE COM_CLONE_DATAITEM_GHOST( WNAME, WANAME, WITHGHOST)
           CHARACTER(*), INTENT(IN) :: WNAME, WANAME
           INTEGER, INTENT(IN) :: WITHGHOST
         END SUBROUTINE COM_CLONE_DATAITEM_GHOST

         SUBROUTINE COM_CLONE_DATAITEM_SUB( WNAME, WANAME, WITHGHOST, PTNNAME, VAL)
           CHARACTER(*), INTENT(IN) :: WNAME, WANAME, PTNNAME
           INTEGER, INTENT(IN) :: VAL, WITHGHOST
         END SUBROUTINE COM_CLONE_DATAITEM_SUB
      END INTERFACE

      INTERFACE COM_COPY_DATAITEM
         SUBROUTINE COM_COPY_DATAITEM( WNAME, WANAME)
           CHARACTER(*), INTENT(IN) :: WNAME, WANAME
         END SUBROUTINE COM_COPY_DATAITEM
         
         SUBROUTINE COM_COPY_DATAITEM_GHOST( WNAME, WANAME, WITHGHOST)
           CHARACTER(*), INTENT(IN) :: WNAME, WANAME
           INTEGER, INTENT(IN) :: WITHGHOST
         END SUBROUTINE COM_COPY_DATAITEM_GHOST

         SUBROUTINE COM_COPY_DATAITEM_SUB( WNAME, WANAME, WITHGHOST, PTNNAME, VAL)
           CHARACTER(*), INTENT(IN) :: WNAME, WANAME, PTNNAME
           INTEGER, INTENT(IN) :: VAL, WITHGHOST
         END SUBROUTINE COM_COPY_DATAITEM_SUB

         SUBROUTINE COM_COPY_DATAITEM_HDLS( TRG_HDL, SRC_HDL)
           INTEGER, INTENT(IN) :: TRG_HDL, SRC_HDL
         END SUBROUTINE COM_COPY_DATAITEM_HDLS
         
         SUBROUTINE COM_COPY_DATAITEM_GHOST_HDLS( TRG_HDL, SRC_HDL, WG)
           INTEGER, INTENT(IN) :: TRG_HDL, SRC_HDL, WG
         END SUBROUTINE COM_COPY_DATAITEM_GHOST_HDLS
         
         SUBROUTINE COM_COPY_DATAITEM_SUB_HDLS( TRG_HDL, SRC_HDL, WG, PNT, VAL)
           INTEGER, INTENT(IN) :: TRG_HDL, SRC_HDL, WG, PNT, VAL
         END SUBROUTINE COM_COPY_DATAITEM_SUB_HDLS
      END INTERFACE
      ...
      INTERFACE
         SUBROUTINE COM_GET_DATAITEM( WA_NAME, LOC, TYPE, SIZE, UNIT)
           CHARACTER(*), INTENT(IN) :: WA_NAME
           CHARACTER, INTENT(OUT)   :: LOC
           CHARACTER(*), INTENT(OUT):: UNIT
           INTEGER, INTENT(OUT)     :: TYPE, SIZE
         END SUBROUTINE COM_GET_DATAITEM
         ...
         SUBROUTINE COM_GET_DATAITEMS( W_NAME, NATTS, NAMES)
           CHARACTER(*), INTENT(IN) :: W_NAME
           INTEGER, INTENT(INOUT) :: NATTS
           CHARACTER, POINTER :: NAMES(:)
         END SUBROUTINE COM_GET_DATAITEMS
      ...
      INTERFACE
         ...
         FUNCTION COM_GET_DATAITEM_HANDLE( WANAME)
           CHARACTER(*), INTENT(IN) :: WANAME
           INTEGER :: COM_GET_DATAITEM_HANDLE
         END FUNCTION COM_GET_DATAITEM_HANDLE

         FUNCTION COM_GET_DATAITEM_HANDLE_CONST( WANAME)
           CHARACTER(*), INTENT(IN) :: WANAME
           INTEGER :: COM_GET_DATAITEM_HANDLE_CONST
         END FUNCTION COM_GET_DATAITEM_HANDLE_CONST
      ...
      INTERFACE ! OBSOLETE
         ...
         SUBROUTINE COM_INIT_DATAITEM
         END SUBROUTINE COM_INIT_DATAITEM
  
         SUBROUTINE COM_INIT_DATAITEM_SRIDED
         END SUBROUTINE COM_INIT_DATAITEM_SRIDED
  
         SUBROUTINE COM_ALLOCATE_DATAITEM
         END SUBROUTINE COM_ALLOCATE_DATAITEM
  
         SUBROUTINE COM_GET_DATAITEM_ADDR
         END SUBROUTINE COM_GET_DATAITEM_ADDR
  
         SUBROUTINE COM_GET_DATAITEM_INFO
         END SUBROUTINE COM_GET_DATAITEM_INFO
