...
/** @file commpi.h
 *  Contains declarations of MPI subroutines used in COPM.
...
extern int MPI_Alltoallv(void *sendbuf, int *sendcount, int *senddispls,
...
extern int MPI_Irecv(void *buf, int count, MPI_Datatype datatype, int src,
                     int tag, MPI_Comm comm, MPI_Request *request);
...
/// Begins a nonblocking send
extern int COMMPI_Isend(void *buf, int count, MPI_Datatype datatype, int dest,
                        int tag, MPI_Comm comm, MPI_Request *request);
//@}

/// Begins a nonblocking receive
extern int COMMPI_Irecv(void *buf, int count, MPI_Datatype datatype, int src,
                        int tag, MPI_Comm comm, MPI_Request *request);
