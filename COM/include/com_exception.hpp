...
/** Error codes */
enum Error_code {
  COM_WARN_DUP_WINDOW = 100,
  COM_WARN_DUP_DATAITEM,
  COM_WARN_DUP_FUNCTION,
  COM_WARN_DUP_FUNC,
  COM_WARN_EMPTY_MESH,
  COM_WARN_MODULE_LOADED,
  COM_ERR_MODULE_NOTLOADED = 1000,
  ...
  COM_ERR_DATAITEM_INITIALIZED,
  COM_ERR_DATAITEM_ALLOCATED,
  COM_ERR_DATAITEM_NOT_ALLOCATED,
  ...
  COM_ERR_INVALID_DATAITEM_HANDLE,
...
struct COM_exception {
  ...
  COM_exception(Error_code i, const std::string &m = std::string())
      : ierr(i), msg(m) {}
  /// Copy constructor.
  COM_exception(const COM_exception &e) : ierr(e.ierr), msg(e.msg) {}
