...
extern "C" void simpal_load_module( const char *name, int length)
{ Rocblas::init( std::string(name, length)); }
extern "C" void simpal_unload_module( const char *name, int length) 
{ Rocblas::finalize( std::string(name, length)); }

extern "C" void simpal_load_module_( const char *name, int length)
{ Rocblas::init( std::string(name, length)); }
extern "C" void simpal_unload_module_( const char *name, int length) 
{ Rocblas::finalize( std::string(name, length)); }
