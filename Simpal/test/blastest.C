...
int main(int argc, char *argv[]) {
   ...
   //Register normal dataitems.
   COM_new_dataitem("twin.xn", 'n', COM_DOUBLE, 3, "m/s");
   COM_new_dataitem("twin.yn", 'n', COM_DOUBLE, 3, "m/s");
   COM_new_dataitem("twin.zn", 'n', COM_DOUBLE, 3, "m/s");
   COM_new_dataitem("twin.pn", 'n', COM_DOUBLE, 1, "m/s");
   COM_new_dataitem("twin.mn", 'n', COM_INTEGER, 1, "");
   COM_new_dataitem("twin.xe", 'e', COM_DOUBLE, 3, "m/s");
   COM_new_dataitem("twin.ye", 'e', COM_DOUBLE, 3, "m/s");
   COM_new_dataitem("twin.ze", 'e', COM_DOUBLE, 3, "m/s");
   COM_new_dataitem("twin.pe", 'e', COM_DOUBLE, 1, "m/s");
   COM_new_dataitem("twin.me", 'e', COM_INTEGER, 1, "");

   //Register staggered dataitems.
   COM_new_dataitem("twin.xns", 'n', COM_DOUBLE, 3, "m/s");
   COM_new_dataitem("twin.yns", 'n', COM_DOUBLE, 3, "m/s");
   COM_new_dataitem("twin.zns", 'n', COM_DOUBLE, 3, "m/s");
   COM_new_dataitem("twin.xes", 'e', COM_DOUBLE, 3, "m/s");
   COM_new_dataitem("twin.yes", 'e', COM_DOUBLE, 3, "m/s");
   COM_new_dataitem("twin.zes", 'e', COM_DOUBLE, 3, "m/s");

   //Scalar dataitem registration and initialization.
   COM_new_dataitem("twin.aw", 'w', COM_DOUBLE, 3, "m/s");
   COM_new_dataitem("twin.ap", 'p', COM_DOUBLE, 3, "m/s");
   COM_new_dataitem("twin.asw", 'w', COM_DOUBLE, 1, "m/s");
   COM_new_dataitem("twin.asp", 'p', COM_DOUBLE, 1, "m/s");
   ...
   for(int pid = 0; pid < NPANE; pid++) {
      ...
      //Initialize staggered dataitems.
   ...
   int arg1 = COM_get_dataitem_handle( a1.c_str()); assert(arg1);
   int arg2 = COM_get_dataitem_handle( a2.c_str()); assert(arg2);
   int arg3 = COM_get_dataitem_handle( a3.c_str()); assert(arg3);
   int arga = COM_get_dataitem_handle( aa.c_str()); 
   int argm = COM_get_dataitem_handle( am.c_str()); 
   int argp = COM_get_dataitem_handle( ap.c_str()); 
